    ...
    public class CMSInterface
    {
        ...
        private bool InsertData(EntityShipment objES)
        {
            ...
            do
            {
                ...
                objES.lstMiscellaneous[x].strMisc4 + "', '" +                  // Reference4
                objES.lstMiscellaneous[x].strMisc5 + "', '" +                  // Reference5
                " " + "', '" +                                                 // VoidIndicator  
                ...
                objES.objBillTo.strCompanyName + "', '" +                      // BillToCompany
                objES.objBillTo.strContactName + "', '" +                      // BillToAttention
                objES.objBillTo.strAddressLine1 + "', '" +                     // BillToAddress1
                objES.objBillTo.strAddressLine2 + "', '" +                     // BillToAddress2
                objES.objBillTo.strCity + "', '" +                             // BillToCity
                objES.objBillTo.strState + "', '" +                            // BillToState
                objES.objBillTo.strPostalCode + "', '" +                       // BillToZip
        ...
        private EntityShipmentDetails FillDetails(DataRow dr, EntityShipmentDetails objSD)
        {
            try
            {
                ...
                if (dr["SourceSystem"] != DBNull.Value) objSD.objMiscellaneous.strMisc1 = dr["SourceSystem"].ToString().Trim();
            }
            catch (Exception ex)
            {
