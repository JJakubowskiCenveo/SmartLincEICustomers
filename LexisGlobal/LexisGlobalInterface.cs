...
namespace LexisGlobal
{
    public class LexisGlobalInterface
    {
        ...
        private DataTable GetShipmentInformation(string strDeliveryDocNumber)
        {
            ...
            sb.Append("Select * from dbo.Shipments where LTRIM(RTRIM(Reference1)) =  '" + strDeliveryDocNumber.Trim() + "'" + "and SourceSystem = 'LexisGlobl' and SQLStatus = 1");
